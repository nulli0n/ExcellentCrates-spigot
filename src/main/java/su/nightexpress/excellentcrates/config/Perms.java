...
public class Perms {
    ...
    public static final JPermission MASS_OPEN = new JPermission(PREFIX + "massopen", "Allows to use mass open feature.", TRUE);
    ...
    public static final JPermission COMMAND_DROP_KEY           = new JPermission(PREFIX_COMMAND + "dropkey", "Access to the '/crate dropkey' sub-command.");
    ...
    public static final JPermission BYPASS_CRATE_OPEN_COST       = new JPermission(PREFIX_BYPASS_OPEN_COST + Placeholders.WILDCARD, "Bypasses all crate open costs.");
